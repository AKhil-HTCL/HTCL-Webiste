            ...
            <div class="row row-gap-4">
              <div class="col-xl-4 col-lg-6 col-sm-6">
                <div class="contact-item style-2 wow fadeInUp" data-wow-delay=".3s">
                  ...
                  <p>Prestige Cube, Hosur Road, Bengaluru, Karnataka 560030</p>
                </div>
              </div>
              ...
              <div class="col-xl-4 col-lg-6 col-sm-6">
                <div class="contact-item style-2 wow fadeInUp" data-wow-delay=".3s">
                  ...
                  <h3 class="contact-title">New Delhi</h3>
                  <p>Eldeco Centre, Malviya Nagar, Shivalik Colony,Delhi, DL 110017</p>
                </div>
              </div>
              ...
              <div class="col-xl-4 col-lg-6 col-sm-6">
                <div class="contact-item style-2 wow fadeInUp" data-wow-delay=".3s">
                  ...
                  <h3 class="contact-title">Mumbai</h3>
