        ...
        <div class="hamburger-infos">
          ...
          <div class="contact-info">
            <div class="contact-item">
              ...
              <a class="contact-link" href="tel:+919846092957">+91 9846092957</a>
            </div>
            <div class="contact-item">
                ...
                <ul>
                  ...
                  <li class="has-dropdown"><a>Solutions</a>
                    <ul class="sub-menu  mega-menu-service">
                      ...
                      <li> <a class="mega-menu-service-single" href="#"> <span
                  ...
                  <li class="has-dropdown"><a>Services</a>
                    <ul class="sub-menu  mega-menu-service">
                      ...
                      <li> <a class="mega-menu-service-single" href="#"> <span
                            ...
                            class="mega-menu-service-nav"><i class="tji-arrow-right-long"></i><i
                              class="tji-arrow-right-long"></i></span></a></li>
                      <li> <a class="mega-menu-service-single" href="https://qcmcertifications.com/" target="_blank"> <span
                            class="mega-menu-service-icon">
                            <i class="tji-service-6"></i>
                          </span> <span class="mega-menu-service-title">Quality Consulting</span> <span
                            class="mega-menu-service-nav"><i class="tji-arrow-right-long"></i><i
                              class="tji-arrow-right-long"></i></span></a></li>
                    </ul>
                  </li>
