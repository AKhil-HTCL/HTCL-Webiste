    ...
    <div id="smooth-content">
      <main id="primary" class="site-main">
        ...
        <section class="h5-banner-section section-gap-x">
          <div class="banner-bg" data-bg-image="assets/images/hero/hero.png"></div>
          <div class="h5-banner-area">
            <div class="h5-banner-content">
              <h1 class="banner-title text-anim">Expert Solutions for Modern Enterprises.</h1>
              <div class="btn-area wow fadeInUp" data-wow-delay=".8s"> <a class="tj-primary-btn" href="contact.html">
                  <span class="btn-text"><span>Get Started Now</span></span> <span class="btn-icon"><i
                      class="tji-arrow-right-long"></i></span> </a> </div>
            </div>
            <div class="solution-box"> <span class="list-icon"><i class="tji-list"></i></span>
              <p class="desc">Committed to delivering innovative solutions that drive success. With a focus on quality.
              </p>
            </div>
          </div>
          <div class="bg-shape-1"> <img src="assets/images/shape/pattern-2.svg" alt=""> </div>
          <div class="bg-shape-2"> <img src="assets/images/shape/pattern-3.svg" alt=""> </div>
          <div class="banner-scroll wow fadeInDown" data-wow-delay="1.5s"> <a href="#choose" class="scroll-down">
              <span><i class="tji-arrow-down-long"></i></span> Scroll Down </a> </div>
        </section>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide client-item h5-client-item">
                <div class="client-logo">
                  <img src="assets/images/brands/h5-brand-1.png" alt="">
                </div>
              </div>
              <div class="swiper-slide client-item h5-client-item">
                <div class="client-logo">
                  <img src="assets/images/brands/h5-brand-2.png" alt="">
                </div>
              </div>
              <div class="swiper-slide client-item h5-client-item">
                <div class="client-logo">
                  <img src="assets/images/brands/h5-brand-3.png" alt="">
                </div>
              </div>
              <div class="swiper-slide client-item h5-client-item">
                <div class="client-logo">
              ...
              <div class="swiper-slide client-item h5-client-item">
                <div class="client-logo">
                  <img src="assets/images/brands/h5-brand-5.png" alt="">
                </div>
              </div>
              <div class="swiper-slide client-item h5-client-item">
                <div class="client-logo">
                  <img src="assets/images/brands/h5-brand-6.png" alt="">
                </div>
              </div>
              <div class="swiper-slide client-item h5-client-item">
                <div class="client-logo">
                  <img src="assets/images/brands/h5-brand-7.png" alt="">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row ">
              ...
              <div class="col-12 col-md-6 col-lg-4">
                <div class="h5-strategy-item h5-strategy-item-1 wow fadeInUp" data-wow-delay=".3s">
                  <h4 class="h5-strategy-title">Growing Business</h4>
                  ...
                  <div class="h5-strategy-counter">
                    <div class="count-inner h5-strategy-counter-inner">
                      ...
                      <span class="count-text">Satisfied customers work with our HTCL.</span>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <div class="testimonial-item">
                          ...
                          <div class="desc">
                            <p>“Working with HTCL has been a game-changer for our business. Their team's
                              professionalism,
