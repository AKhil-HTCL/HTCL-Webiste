            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="tj-page-header-content text-center">
                  <h1 class="tj-page-title">Our Company</h1>
                ...
                <div class="about-content-area">
                  <div class="sec-heading">
                    ...
                    <h2 class="sec-title title-anim">
                      HTCL: Your Trusted Partner in Technology & Innovation
                    </h2>
                    <p>HTCL Technologies Pvt Ltd is an ISO 9001:2015 7 ISO 27001 certified and is a pioneer in IT,
                      Engineering & Telecom Services. We provide solutions to clients world wide. HTCL was established
                      in 2023.

                      As a CMMI level 3 organization, HTCL solutions are provided with streamlined processes and quality
                      support services.</p>
                    <p>
                      We provide tech-related services, products, and solutions, managing digital infrastructure like
                      software, networks, and data for businesses, ranging from custom application development
                      (web/mobile) and cloud computing to cybersecurity and IT consulting, helping other organizations
                      operate efficiently and digitally.
                    </p>
                    <p>
                      We also provide MEP engineering services across India. As one of the top Engineering services
                      headquartered in Bangalore , we offer comprehensive MEP (Mechanical, Electrical & Plumbing)
                      contractor services in Bangalore, ensuring high-quality project execution from start to finish.
                      Our commitment to excellence has earned us the reputation of delivering the Engineering services
                      in Bangalore .
                    </p>
                    <p>
                      We are committed to the green revolution and deliver end to end sustainability projects.
                    </p>
                  </div>
                </div>
            ...
            <div class="accordion tj-faq" id="faqOne">
              <div class="accordion-item active wow fadeInUp" data-wow-delay=".3s">
                <button class=" faq-title" type="button" data-bs-toggle="collapse" data-bs-target="#faq-1"
                  aria-expanded="true">What services does HTCL offer to clients?</button>
