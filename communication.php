                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="tj-page-header-content text-center">
                                        <h1 class="tj-page-title">Communication Solution</h1>
                                        <div class="tj-page-link">
                                            ...
                                            <span>
                                                <span>Communication Solution</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <div class="image-box wow fadeInUp" data-wow-delay=".3s">
                                                            <img src="assets/images/service/soln-17.png" alt="Image">
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <div class="image-box wow fadeInUp" data-wow-delay=".5s">
                                                            <img src="assets/images/service/soln-18.png" alt="Image">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tj-main-sidebar slidebar-stickiy">
                                        <div class="tj-sidebar-widget service-categories wow fadeInUp"
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="support-maintenance.php">IT Support & Maintenance<span
                                                            class="icon"><i class="tji-arrow-right"></i></span></a></li>
